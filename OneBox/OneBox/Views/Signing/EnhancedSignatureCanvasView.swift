...
class TouchableCanvasView: UIView {
    ...
    // Don't manually forward touches - let PencilKit handle them through hitTest
    // Manually forwarding can interfere with PencilKit's internal gesture recognizers
}
