...
- **Actions**: Convert Images→PDF, Compress PDF, Merge PDFs
...
7. **Share Extension**: 20 images from Photos → PDF flow works
8. **Shortcuts**: "Compress PDF to 3 MB" runs headless
9. **No Crashes**: iPhone 12/15, iPad 9th/Pro
