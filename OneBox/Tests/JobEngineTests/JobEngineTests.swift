...
final class JobEngineTests: XCTestCase {
    ...
    func testJobTypeDisplayNames() {
        ...
        XCTAssertEqual(JobType.videoCompress.displayName, "Compress Video")
        XCTAssertEqual(JobType.zip.displayName, "Create ZIP")
        XCTAssertEqual(JobType.unzip.displayName, "Extract ZIP")
    }
    ...
    func testAllJobTypes() {
        ...
        XCTAssertTrue(allTypes.contains(.videoCompress))
    }
    ...
    func testCompressionQualityValues() {
        ...
        XCTAssertEqual(CompressionQuality.medium.jpegQuality, 0.7)
